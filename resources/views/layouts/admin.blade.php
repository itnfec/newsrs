...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/plugins/datatables-bs4/css/responsive.dataTables.min.css') }}">
...
<script src="{{ asset('assets/plugins/datatables-bs4/js/dataTables.responsive.min.js') }}"></script>
